  ...
  $(function() {
    $("#add-library").on("click", function() {
      ...
      if ( $val === "" ) {
        ...
        txt="    <"+"script src=\"https://ajax.googleapis.com/ajax/libs/angularjs/1.0.7/angular.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["backbone", "backbonejs"]) > -1) {
        txt1="    <"+"script src=\"http://documentcloud.github.io/backbone/backbone-min.js\">"+"</"+"script"+">\n";
        txt2="    <"+"script src=\"http://documentcloud.github.io/underscore/underscore-min.js\">"+"</"+"script"+">";
        appendLib(txt1 + txt2);
      } else if ($.inArray($val.toLowerCase(), ["bootstrap"]) > -1) {
        txt1="    <"+"link rel=\"stylesheet\" href=\"http://getbootstrap.com/dist/css/bootstrap.css\" />\n";
        txt2="    <"+"script src=\"http://code.jquery.com/jquery.min.js\">"+"</"+"script"+">\n";
        txt3="    <"+"script src=\"http://getbootstrap.com/dist/js/bootstrap.js\">"+"</"+"script"+">";
        appendLib(txt1 + txt2 + txt3);
      } else if ($.inArray($val.toLowerCase(), ["createjs", "create js"]) > -1) {
        txt="    <"+"script src=\"http://code.createjs.com/createjs-2013.09.25.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["chartjs", "chart js"]) > -1) {
        txt="    <"+"script src=\"http://cdnjs.cloudflare.com/ajax/libs/Chart.js/0.2.0/Chart.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["d3"]) > -1) {
        txt="    <"+"script src=\"http://d3js.org/d3.v3.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["dojo"]) > -1) {
        txt="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/dojo/1/dojo/dojo.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["ember"]) > -1) {
        txt="    <"+"script src=\"http://builds.emberjs.com/tags/v1.1.2/ember.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["enyojs", "enyo js"]) > -1) {
        txt="    <"+"script src=\"http://nightly.enyojs.com/latest/enyo/enyo.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["extjs", "ext js"]) > -1) {
        txt="    <"+"script src=\"http://cdn.sencha.io/ext-4.2.0-gpl/ext-all.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["fabricjs", "fabric js"]) > -1) {
        txt="    <"+"script src=\"http://cdnjs.cloudflare.com/ajax/libs/fabric.js/1.3.0/fabric.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["fontawesome", "font awesome", "fa"]) > -1) {
        txt="    <"+"link rel=\"stylesheet\" href=\"http://netdna.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.css\" />";
        appendLib(txt);
        ...
        txt1="    <"+"link rel=\"stylesheet\" href=\"http://ajax.googleapis.com/ajax/libs/jqueryui/1/themes/smoothness/jquery-ui.css\" />\n";
        txt2="    <"+"script src=\"http://code.jquery.com/jquery-latest.min.js\">"+"</"+"script"+">\n";
        txt3="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/jqueryui/1/jquery-ui.min.js\">"+"</"+"script"+">";
        appendLib(txt1 + txt2 + txt3);
      } else if ($.inArray($val.toLowerCase(), ["jqmobile", "jq mobile", "jquerymobile", "jquery mobile"]) > -1) {
        txt1="    <"+"link rel=\"stylesheet\" href=\"http://demos.jquerymobile.com/1.4.5/css/themes/default/jquery.mobile-1.4.5.min.css\" />\n";
        txt2="    <"+"script src=\"http://code.jquery.com/jquery-latest.min.js\">"+"</"+"script"+">\n";
        txt3="    <"+"script src=\"http://demos.jquerymobile.com/1.4.5/js/jquery.mobile-1.4.5.min.js\">"+"</"+"script"+">";
        appendLib(txt1 + txt2 + txt3);
      } else if ($.inArray($val.toLowerCase(), ["jqtools", "jq tools", "jquerytools", "jquery tools"]) > -1) {
        txt="    <"+"script src=\"http://cdn.jquerytools.org/1.2.7/full/jquery.tools.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["jszip"]) > -1) {
        txt1="    <"+"script src=\"http://stuk.github.io/jszip/dist/jszip.min.js\">"+"</"+"script"+">\n";
        txt2="    <"+"script src=\"http://stuk.github.io/jszip-utils/dist/jszip-utils.js\">"+"</"+"script"+">\n";
        txt3="    <"+"script src=\"http://stuk.github.io/jszip/vendor/FileSaver.js\">"+"</"+"script"+">";
        appendLib(txt1 + txt2 + txt3);
      } else if ($.inArray($val.toLowerCase(), ["kineticjs", "kinetic js"]) > -1) {
        txt="    <"+"script src=\"http://d3lp1msu2r81bx.cloudfront.net/kjs/js/lib/kinetic-v4.7.3.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["knockoutjs", "knockout js"]) > -1) {
        txt="    <"+"script src=\"http://knockoutjs.com/downloads/knockout-3.0.0.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["modernizr"]) > -1) {
        txt="    <"+"script src=\"http://modernizr.com/downloads/modernizr-latest.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["mootools"]) > -1) {
        txt="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/mootools/1/mootools-yui-compressed.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["normalize"]) > -1) {
        txt="    <"+"link rel=\"stylesheet\" href=\"http://necolas.github.io/normalize.css/3.0.1/normalize.css\" />";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["paperjs", "paper js"]) > -1) {
        txt="    <"+"script src=\"http://cdnjs.cloudflare.com/ajax/libs/paper.js/0.9.9/paper.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["processingjs", "processing js"]) > -1) {
        txt="    <"+"script src=\"http://cloud.github.com/downloads/processing-js/processing-js/processing-1.4.1.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["prototypejs", "prototype js"]) > -1) {
        txt="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/prototype/1/prototype.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["qooxdoo"]) > -1) {
        txt="    <"+"script src=\"http://demo.qooxdoo.org/3.0.1/framework/q-3.0.1.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["raphaeljs", "raphael js"]) > -1) {
        txt="    <"+"script src=\"http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["requirejs", "require js"]) > -1) {
        txt="    <"+"script src=\"http://requirejs.org/docs/release/2.1.16/minified/require.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["script.aculo.us", "script aculous", "scriptaculous"]) > -1) {
        txt="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/scriptaculous/1/scriptaculous.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["snapsvg", "snap js"]) > -1) {
        txt="    <"+"script src=\"http://snapsvg.io/assets/js/snap.svg-min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["svgjs", "svg js"]) > -1) {
        txt="    <"+"script src=\"https://raw.github.com/wout/svg.js/master/dist/svg.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["threejs", "three js", "3js", "3 js"]) > -1) {
        txt="    <"+"script src=\"http://threejs.org/build/three.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["underscorejs", "underscore js"]) > -1) {
        txt="    <"+"script src=\"http://underscorejs.org/underscore-min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["webfontloader", "web font loader", "wfl", "webfont loader", "web fontloader"]) > -1) {
        txt="    <"+"script src=\"http://ajax.googleapis.com/ajax/libs/webfont/1.4.10/webfont.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["yui"]) > -1) {
        txt="    <"+"script src=\"http://yui.yahooapis.com/3.13.0/build/yui/yui-min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($.inArray($val.toLowerCase(), ["zepto"]) > -1) {
        txt="    <"+"script src=\"http://zeptojs.com/zepto.min.js\">"+"</"+"script"+">";
        appendLib(txt);
      } else if ($val.toLowerCase().substring($val.length - 3) === ".js") {
        txt="    <"+"script src=\""+ $val +"\">"+"</"+"script"+">";
        appendLib(txt);
